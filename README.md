...
O desafio de projeto é dar um fork no repositório da DIO do projeto open source no GitHub e dar um pull request, contribuindo com o projeto de um arquivo Markdown com um perfil no GitHub.
